...
import (
	...
	interfaces "github.com/ryt-io/ryt-v2/graft/ethereum/interfaces"
...
func (_m *EthClient) AcceptedCallContract(_a0 context.Context, _a1 ethereum.CallMsg) ([]byte, error) {
...
func (_m *EthClient) CallContract(_a0 context.Context, _a1 ethereum.CallMsg, _a2 *big.Int) ([]byte, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *EthClient) EstimateGas(_a0 context.Context, _a1 ethereum.CallMsg) (uint64, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *EthClient) FilterLogs(_a0 context.Context, _a1 ethereum.FilterQuery) ([]types.Log, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *EthClient) SubscribeFilterLogs(_a0 context.Context, _a1 ethereum.FilterQuery, _a2 chan<- types.Log) (interfaces.Subscription, error) {
	ret := _m.Called(_a0, _a1, _a2)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ethereum.FilterQuery, chan<- types.Log) (interfaces.Subscription, error)); ok {
		return rf(_a0, _a1, _a2)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ethereum.FilterQuery, chan<- types.Log) interfaces.Subscription); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
